...
const deployScrollFighter: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
  ...
  */
  ...
  await deploy("ScrollFighterV2", {
    from: deployer,
    // Contract constructor arguments
    // args: [verifier_contract_address],
    args: ["0x4a2B33A77de8F69b8Cf913aafc6357f4Ce176105", "0x64CDeB6CD5ecfB002bdaFabc98B5C883C5C06B27"],
    log: true,
  ...
  await hre.ethers.getContract<Contract>("ScrollFighterV2", deployer);
...
deployScrollFighter.tags = ["ScrollFighterV2"];
